...
class CompositedViewController : UIViewController, VCConnectorIConnect {
    ...
    let VIDYO_TOKEN     = "cHJvdmlzaW9uAHVzZXIxQGU3MWViZi52aWR5by5pbwA2MzY5ODYyOTU1MwAANTMyMjRiNjgzMDczNTQwNTIwZDk3NmFlOTljYzVlOTVjMGI4OWU2OGNiYmYzNTNlOWYwYWY3NzVkNjVhNzBmMWI5NDRmMGU5Nzc0NjkyMTc1Yzg0YzFkMTUxMzNlM2Y5" // Get a valid token. It is recommended that you create short lived tokens on your applications server and then pass it down here. For details on how to get a token check out - https://developer.vidyo.io/documentation/4-1-19-7/getting-started#Tokens
